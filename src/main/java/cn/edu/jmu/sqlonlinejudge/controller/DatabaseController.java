...
//            basicResponse.wrapper(200, null, new PageInfo<>(databaseService.selectAll()));
//        } catch (Exception e) {
...
//        BasicResponse basicResponse = new BasicResponse();
//        try {
//            basicResponse.wrapper(200, null, databaseService.selectAll());
//        } catch (Exception e) {
//            basicResponse.wrapper(503, e.getCause().toString());
//        }
//        return basicResponse;
...
//            if (database != null) {
//                basicResponse.wrapper(200, null, database);
//            } else {
//                basicResponse.wrapper(400, "无此数据库");
//            }
//        } catch (Exception e) {
//            basicResponse.wrapper(503, e.getCause().toString());
//        }
...
//                basicResponse.wrapper(200, "数据库添加成功");
//            } else {
//                basicResponse.wrapper(400, "数据库添加失败");
//            }
//        } catch (Exception e) {
//            basicResponse.wrapper(503, e.getCause().toString());
//
...
//                basicResponse.wrapper(200, "数据库更新成功");
//            } else {
//                basicResponse.wrapper(400, "数据库更新失败");
//            }
//        } catch (Exception e) {
//            basicResponse.wrapper(503, e.getCause().toString());
//        }
...
//            if (databases != null) {
//                basicResponse.wrapper(200, null, new PageInfo<>(databases));
//            } else {
//                basicResponse.wrapper(400, "无符合条件的数据库");
//            }
//        } catch (Exception e) {
//            basicResponse.wrapper(503, e.getCause().toString());
//        }
...
//        BasicResponse basicResponse = new BasicResponse();
//        try {
//            basicResponse.wrapper(200, null, databaseService.countAll());
//        } catch (Exception e) {
//            basicResponse.wrapper(503, e.getCause().toString());
//        }
//        return basicResponse;
