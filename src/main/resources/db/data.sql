...
CREATE TABLE IF NOT EXISTS `problem_detail` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='题目的详细描述';
...
INSERT INTO `sys_user` (`id`, `username`, `email`, `reel_name`, `password`, `salt`, `submit`, `solved`, `avatar`, `status`) VALUES
	(1, '1', '1', NULL, 'c4ca4238a0b923820dcc509a6f75849b', '', 100, 0, NULL, '1'),
