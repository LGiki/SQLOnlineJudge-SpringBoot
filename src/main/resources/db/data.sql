...
/*!40000 ALTER TABLE `data_base`
    DISABLE KEYS */;
INSERT INTO `data_base` (`id`, `name`, `create_table`, `test_data`, `is_created`)
VALUES (1, '1', '1', '1', b'1');
/*!40000 ALTER TABLE `data_base`
    ENABLE KEYS */;
...
/*!40000 ALTER TABLE `problem`
    DISABLE KEYS */;
INSERT INTO `problem` (`id`, `title`, `description`, `sample_output`, `hint`, `answer`, `solve`, `submit`,
                       `true_result`, `need_order`, `database_id`)
VALUES (1, '1', '1', '1', '1', '1', 0, 0, '1', b'1', 1),
...
/*!40000 ALTER TABLE `sys_admin`
    DISABLE KEYS */;
INSERT INTO `sys_admin` (`id`, `username`, `password`, `salt`)
VALUES (1, 'admin', 'admin', '8d78869f470951332959580424d4bf4f'),
       (2, 'a', 'a', 'a');
/*!40000 ALTER TABLE `sys_admin`
    ENABLE KEYS */;
...
/*!40000 ALTER TABLE `sys_admin_role`
    DISABLE KEYS */;
INSERT INTO `sys_admin_role` (`id`, `a_id`, `r_id`)
VALUES (1, 1, 1);
/*!40000 ALTER TABLE `sys_admin_role`
    ENABLE KEYS */;
...
/*!40000 ALTER TABLE `sys_user`
    DISABLE KEYS */;
INSERT INTO `sys_user` (`id`, `username`, `email`, `password`, `salt`, `submit`, `solved`, `avatar`, `status`)
VALUES (1, '1', '1', '1', '', 100, 5, 'default.jpg', '1'),
       (2, '2', '2', '2', '2', 5555, 6, 'default.jpg', '0'),
